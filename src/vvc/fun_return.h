...
{
	int trigger;
	boost::posix_time::ptime timer_overv;
	boost::posix_time::ptime timer_underv;
	int re1;
	int flag;
};

VCtrig VoltReg_trigger(arma::mat Dl, arma::cx_mat Z, int Nnum, boost::posix_time::ptime timer_overvolt, boost::posix_time::ptime timer_undervolt, int flag);//output of VoltReg_trigger
...
gradV grad_Volt_opt_solve(arma::mat Dl_vr, double v0, arma::cx_mat Z, double bkva, arma::mat Dl_pv, arma::mat PV_node);//output of grad_Volt_opt_solve
...
gradVAR var_opt_loss_solver(arma::mat Dl_vr, double v0, arma::cx_mat Z, double bkva, arma::mat Dl_pv, arma::mat PV_node);//output of var_opt_loss_solver
#endif
